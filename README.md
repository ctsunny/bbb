...
[![Version](https://img.shields.io/badge/version-v1.8.5-blue.svg)](https://github.com/ctsunny/bbb)
...
#### 1.1 项目定位
NanoMonitor 是一款专为 Linux VPS 设计的轻量级网页内容变动监控工具（当前版本 **v1.8.5**）。它通过无头浏览器自动抓取指定网页，利用智能算法过滤广告、时间戳等噪音内容，精准识别页面核心内容的变化，并通过 Bark 推送实时通知用户。
